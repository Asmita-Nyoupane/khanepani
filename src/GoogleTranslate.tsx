...
const GoogleTranslate = () => {
    ...
    return (
        <div className="flex flex-col items-end">
            ...
            >
                <SelectTrigger className="flex items-center  gap-2 border px-3 py-2 rounded-lg bg-white shadow-sm">
                    <Image
                    ...
                    />
                    <SelectValue className="flex gap-2"> {currentLanguage.label}</SelectValue>
                </SelectTrigger>
                <SelectContent className="bg-white shadow-lg rounded-lg mt-2">
                    {languages.map((lang) => (
                        <SelectItem key={lang.value} value={lang.value} className="flex  flex-row items-center gap-2 px-4 py-2">
                            <Image
                                src={lang.flag}
                                alt={lang.label}
                                width={20}
